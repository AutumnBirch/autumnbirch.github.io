...
HTML,CSS,Javascript,Vue,GdScript

学习中：Vue,TypeScript,C/C++/C#,Python
...
目前主要补习转专业后落下的课程，然后是学习Vue3.0和TypeScript，以及数据可视化相关内容，接下来应该会向数据分析/AI（深度学习、机器学习）这方面靠拢并且深入学习；

- 闲余时间也在学习使用GoDot开发2D游戏；

- 其次就是持续完善本站内容，写点经验之谈以及杂七杂八的教程；

- （个人笔记有些杂乱，整理完成后会挑选部分上传至此）

- 之后可能会根据兴趣学些其他工科专业的内容，比如STM32单片机之类的🤔，当然，权作兴趣。
</details>
